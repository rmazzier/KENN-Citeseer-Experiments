...
def train_and_evaluate_kenn_transductive_greedy(percentage_of_training, verbose=True):
    ...
    nn_preactivations_train,nn_preactivations_valid,nn_preactivations_test, nn_results = train_and_evaluate_standard(percentage_of_training, verbose=verbose)
    nn_preactivations = np.concatenate((nn_preactivations_train, nn_preactivations_valid, nn_preactivations_test), axis=0)
